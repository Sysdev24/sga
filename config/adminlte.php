...
return [
    ...
    */
    ...
    'classes_auth_footer' => '',
    'classes_auth_icon' => 'fa-lg text-black',
    ...
    */
     ...
     //Desplegar Menu del lado Derecho

    'right_sidebar' => false,  // <--- Activacion del menú lado Derecho
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'label_color' => 'green',
            'icon_color' => 'white',
	        'can'  => 'carga_documento.index',

        ],

            // Menú de Reporte

        //['header' => 'Menú de Reportes'],
            ...
            'submenu' => [
               ...
               [
                   'text' => 'Reporte documentos',
                    'url'  => '/reportes_documentos',
                    'icon' => 'fas fa-file-signature',
                    'icon_color' => 'green',
                    'can'  => 'usuarios.reportes_documentos',
                ],
              /*  [
                    'text' => 'Auditoria Usuarios',
                    'url'  => '/#',
                    'icon' => 'fas fa-file-signature',
                    'icon_color' => 'green',
                    //'can'  => 'usuarios.reportes_documentos',
       ...
       // ['header' => 'Menú de Configuraciones'],
        ...
        [
            ...
            'submenu' => [
                ...
                'submenu' => [
                [
                    'text' => 'Gerencias Generales',
                    'url'  => '/gerencia_general',
                    'icon' => 'fa fa-suitcase',
                    'icon_color' => 'green',
                    'can' => 'gerencia_general.index',
                ],

                        [
                            'text' => 'Gerencias Nacionales',
                            'url'  => '/area_trabajo',
                            'icon' => 'fas fa-network-wired',
                            'icon_color' => 'green',
                            'can' => 'area_trabajo.index',
                        ],
